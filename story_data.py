...
就在他试图再次将目光聚焦在屏幕上时，轻微的脚步声在门外响起。刘枭没有抬头，甚至没有转动视线。但他知道——是Vein。''',
        ...
        "chapter": "序章",
        "time": "00:00 - 01:00",
        "audio": [{"src": "static/audio/forest_mixtape.mp3", "loop": True},
                    {"src": "static/audio/菜鸟图库-下雨.mp3", "loop": False}],  # 开始场景的背景音乐   
...
刘枭叹了口气，他知道躲不过去了。''',
        ...
        "chapter": "序章",
        "time": "00:00 - 01:00",
        "audio": [{"src": "static/audio/forest_mixtape.mp3", "loop": True}],  # 继续使用同一音频，不会重新播放
    },
...
两人的关系更加亲密，Vein对刘枭的信任加深。这次冒险让刘枭意识到，他愿意为Vein冒任何风险。''',
    ...
    "go_home_play": {
        "text": '''刘枭的目光迅速扫过眼前的场馆，无奈却又带着点如释重负的浅笑浮现在脸上。
